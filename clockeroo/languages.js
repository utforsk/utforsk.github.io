...
const uiLanguages = {
  'no': {
    ...
    game: {
      ...
      questionSetTime: 'Still klokka til {time} 🕑',
      checkAnswerButton: 'Sjekk Svar',
  ...
  'en': {
    ...
    game: {
      ...
      questionSetTime: 'Set the clock to {time} 🕑',
...
const timeLanguages = {
  ...
  'ja': {
    ...
    examples: {
      '07:00': '七時 (nana-ji) 朝食',
      '12:00': '十二時 (jū-ni-ji) 昼食',
      '14:00': '二時 (ni-ji) おやつ',
      '17:00': '五時 (go-ji) 夕食',
      '19:00': '七時 (nana-ji) 夜',
      '20:00': '八時 (hachi-ji) 就寝',
      '12:15': '十二時十五分 (jū-ni-ji jū-go-fun)',
      '12:30': '十二時半 (jū-ni-ji-han)',
      '12:45': '一時十五分前 (ichi-ji jū-go-fun mae)'
    },
    numbers: ['十二 (jū-ni)', '一 (ichi)', '二 (ni)', '三 (san)', '四 (yon)', '五 (go)', '六 (roku)', '七 (nana)', '八 (hachi)', '九 (ku)', '十 (jū)', '十一 (jū-ichi)', '十二 (jū-ni)', '一 (ichi)', '二 (ni)', '三 (san)', '四 (yon)', '五 (go)', '六 (roku)', '七 (nana)', '八 (hachi)', '九 (ku)', '十 (jū)', '十一 (jū-ichi)'],
    minuteWords: {
      0: '時 (ji)',
      5: '時五分 (ji go-fun)',
      10: '時十分 (ji jup-pun)',
      15: '時十五分 (ji jū-go-fun)',
      20: '時二十分 (ji ni-jup-pun)',
      25: '時二十五分 (ji ni-jū-go-fun)',
      30: '時半 (ji-han)',
      35: '時三十五分 (ji san-jū-go-fun)',
      40: '時四十分 (ji yon-jup-pun)',
      45: '時四十五分 (ji yon-jū-go-fun)',
      50: '時五十分 (ji go-jup-pun)',
      55: '時五十五分 (ji go-jū-go-fun)'
    },
    use24Hour: true,
    useNextHourForMinutes: []
  }
};